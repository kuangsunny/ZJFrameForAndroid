 ...
 */
package org.sunny.aframe.utils;
...
import org.sunny.aframe.ZJConfig;
import org.sunny.aframe.ZJException;
...
public class SystemTool {
    ...
    public static boolean checkOnlyWifi(Context context) {
        if (PreferenceHelper.readBoolean(context, ZJConfig.SETTING_FILE,
                ZJConfig.ONLY_WIFI)) {
    ...
    public static String getAppVersion(Context context) {
        ...
        try {
            ...
            throw new ZJException(SystemTool.class.getName()
    ...
    public static String getSign(Context context, String pkgName) {
        try {
            ...
            throw new ZJException(SystemTool.class.getName() + "the " + pkgName
